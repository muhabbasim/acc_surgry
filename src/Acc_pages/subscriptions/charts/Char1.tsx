...
type DashElementProps = {
  data: any
}

const Chart1 = ({ data }: DashElementProps) => {
  // chart color
  ...
  return (
    ...
    <>
      <Typography width='350px' fontWeight={600} variant="subtitle2" color="textSecondary">
        <Translatable>
          Bookings for which images have been uploaded by the users
        </Translatable>
      </Typography>

      <Typography variant="h4" mt={1}>{data?.posts.post_types.total}</Typography>
