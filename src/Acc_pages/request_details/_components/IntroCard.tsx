    ...
    <Box width={'100%'} display={'flex'}>
      ...
      <Stack direction="row" gap={2} alignItems="center" mb={3}>
            ...
            <Typography variant="h6"> <Translatable>Name</Translatable> : 
              <Typography px={1} fontSize={18} fontWeight={600} style={{display: 'inline'}} color={ theme.palette.primary.main }>
                {user?.name}
              </Typography>
            </Typography>
          </Stack>
          <Stack direction="row" gap={2} alignItems="center" mb={3}>
            <IconCalendar size="21" />
            <Typography variant="h6"> <Translatable>User Type</Translatable> : <Typography display='inline' color={theme.palette.success.main}>{toUpper(user?.type)}</Typography></Typography>
          </Stack>
        <Stack direction="row" gap={2} alignItems="center" mb={3}>
          <IconPhone size="21" />
          <Typography variant="h6"> <Translatable>ID Number</Translatable> : {user?.idNum}</Typography>
        </Stack>
        <Stack direction="row" gap={2} alignItems="center" mb={3}>
          <IconPhone size="21" />
      ...
      <Box  width={'50%'}>
        <Stack direction="row" gap={2} alignItems="center" mb={3}>
          <IconCalendar size="21" />
          <Typography variant="h6"> <Translatable>Birthdate</Translatable> : {user?.birthdate}</Typography>
        </Stack>
        <Stack direction="row" gap={2} alignItems="center" mb={3}>
          <IconCalendar size="21" />
