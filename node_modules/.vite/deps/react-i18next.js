...
} from "./chunk-TBC3AOYB.js";
import {
  _defineProperty
} from "./chunk-7Y5L6VPR.js";
import {
...
function nodesToString(children, i18nOptions) {
  ...
  childrenArray.forEach(function(child, childIndex) {
    ...
    } else if ((0, import_react2.isValidElement)(child)) {
...
function renderNodes(children, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) {
  ...
  function getData(childs) {
    ...
    childrenArray.forEach(function(child) {
      ...
      else if (_typeof(child) === "object" && !(0, import_react2.isValidElement)(child))
  ...
  function pushTranslatedJSX(child, inner, mem, i2, isVoid) {
    ...
    mem.push((0, import_react2.cloneElement)(child, _objectSpread2(_objectSpread2({}, child.props), {}, {
      key: i2
    }), isVoid ? void 0 : inner));
  }
  function mapAST(reactNode, astNode, rootReactNode) {
    ...
    return astNodes.reduce(function(mem, node, i2) {
      ...
      if (node.type === "tag") {
        ...
        var isElement = (0, import_react2.isValidElement)(child);
        ...
        if (typeof child === "string") {
          ...
          if (isKnownComponent) {
            ...
            if (node.voidElement) {
              mem.push((0, import_react2.createElement)(node.name, {
        ...
        if (wrapTextNodes) {
          mem.push((0, import_react2.createElement)(wrapTextNodes, {
            key: "".concat(node.name, "-").concat(i2)
          }, _content));
        } else {
          mem.push(_content);
...
function Trans(_ref) {
  ...
  return useAsParent ? (0, import_react2.createElement)(useAsParent, additionalProps, content) : content;
}
...
function useTranslation(ns) {
  ...
  var _useState = (0, import_react3.useState)(getT), _useState2 = _slicedToArray(_useState, 2), t2 = _useState2[0], setT = _useState2[1];
...
function withTranslation(ns) {
  ...
  return function Extend(WrappedComponent) {
    function I18nextWithTranslation(_ref) {
      var forwardedRef = _ref.forwardedRef, rest = _objectWithoutProperties(_ref, _excluded3);
      var _useTranslation = useTranslation(ns, _objectSpread4(_objectSpread4({}, rest), {}, {
      ...
      return (0, import_react4.createElement)(WrappedComponent, passDownProps);
    }
    I18nextWithTranslation.displayName = "withI18nextTranslation(".concat(getDisplayName(WrappedComponent), ")");
    I18nextWithTranslation.WrappedComponent = WrappedComponent;
    var forwardRef = function forwardRef2(props, ref) {
      return (0, import_react4.createElement)(I18nextWithTranslation, Object.assign({}, props, {
        forwardedRef: ref
      }));
    };
    return options.withRef ? (0, import_react4.forwardRef)(forwardRef) : I18nextWithTranslation;
  };
}

// node_modules/react-i18next/dist/es/Translation.js
var _excluded4 = ["ns", "children"];
function Translation(props) {
  var ns = props.ns, children = props.children, options = _objectWithoutProperties(props, _excluded4);
...
// node_modules/react-i18next/dist/es/withSSR.js
var _excluded5 = ["initialI18nStore", "initialLanguage"];
...
function withSSR() {
  return function Extend(WrappedComponent) {
    function I18nextWithSSR(_ref) {
      var initialI18nStore = _ref.initialI18nStore, initialLanguage = _ref.initialLanguage, rest = _objectWithoutProperties(_ref, _excluded5);
      useSSR(initialI18nStore, initialLanguage);
      return (0, import_react7.createElement)(WrappedComponent, _objectSpread5({}, rest));
    }
