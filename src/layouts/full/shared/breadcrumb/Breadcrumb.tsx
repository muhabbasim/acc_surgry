...
import { Grid, Typography, Box, Breadcrumbs, Link, Theme, useTheme } from '@mui/material';
import { NavLink } from 'react-router-dom';
import AccLogo from 'src/assets/images/logos/Acc_logo2.png';
          ...
          {children ? (
            ...
            <>
              <Box sx={{ top: '0px', position: 'absolute' }}>
                <img src={AccLogo} alt={AccLogo} width={'120px'} />
              </Box>
            </>
          )}
        </Box>
