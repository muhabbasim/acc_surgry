...
import Data from "src/Acc_landingpage/data/sections/team.json";
                ...
                <div className="row justify-content-between align-items-center">
                    <div className="col-lg-5 col-xl-4">
                        ...
                        <div className="mil-mb-90">
                            ...
                            <div className="mil-up"><Link to={Data.button.link} className="mil-button mil-arrow-place mil-mb-60"><span>{Data.button.label}</span><ArrowIcon /></Link></div>
